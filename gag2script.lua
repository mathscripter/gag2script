...
--// ============================================================
--//  FULL SEED LIST  (from official wiki - all non-exclusive)
--// ============================================================
local SEED_LIST = {
    -- Common
    "Carrot Seed", "Strawberry Seed", "Blueberry Seed", "Tomato Seed",
    "Corn Seed", "Watermelon Seed", "Pumpkin Seed", "Apple Seed",
    "Banana Seed", "Coconut Seed", "Mango Seed", "Pineapple Seed",
    "Grape Seed", "Peach Seed", "Cactus Seed", "Bamboo Seed",
    "Dragon Fruit Seed", "Loquat Seed", "Green Apple Seed", "Avocado Seed",
    "Radish Seed", "Broccoli Seed", "Cauliflower Seed", "Potato Seed",
    "Bell Pepper Seed", "Pepper Seed", "Mushroom Seed", "Rose Seed",
    "Sunflower Seed", "Lilac Seed", "Foxglove Seed", "Daffodil Seed",
    "Orange Tulip Seed", "Raspberry Seed", "Kiwi Seed", "Olive Seed",
    -- Uncommon
    "Sugar Apple Seed", "Cocomango Seed", "Brussels Sprout Seed",
    "Elder Strawberry Seed", "Beanstalk Seed", "Giant Pinecone Seed",
    "Feijoa Seed", "Blue Raspberry Seed", "Horned Melon Seed",
    "Romanesco Seed", "Mandrake Seed", "Cacao Seed",
    "Prickly Pear Seed", "Baobab Seed", "Buttercup Seed",
    "Protea Seed", "Orange Delight Seed", "Yarrow Seed",
    "Ackee Seed", "Peanut Seed",
    -- Rare
    "Maple Resin Seed", "Kniphofia Seed", "Ember Lily Seed",
    "Burning Bud Seed", "Bamboo Hollow Seed", "Auburn Pine Seed",
    "Autumn Shroom Seed", "Speargrass Seed", "Fall Berry Seed",
    "Firewell Seed", "Torchflare Seed",
    -- Legendary
    "Crimson Thorn Seed", "Asteris Seed", "Gem Fruit Seed",
    "Coilvine Seed", "Octobloom Seed", "Zebrazinkle Seed",
    "Evo Apple Seed",
    -- Mythical / Divine / Prismatic / Transcendent
    "Candlite Seed", "Crunchnut Seed", "Peanut Seed",
    "Hexberry Seed", "Yellow Core Seed", "Madcrown Vine Seed",
    "Magma Pepper Seed", "Plumwillow Seed", "Blooming Cactus Seed",
    "Confetti Tula Seed", "Shimmersprout Seed",
    "Crimson Cranberry Seed", "Purple Dahlia Seed", "Pink Lily Seed",
    "Rafflesia Seed", "Pitcher Plant Seed",
}

--// FULL FRUIT/CROP LIST for Seed Rain (all harvestable crop names)
local SEED_RAIN_LIST = {
    -- Common
    "Carrot","Strawberry","Blueberry","Tomato","Corn","Watermelon",
    "Pumpkin","Apple","Banana","Coconut","Mango","Pineapple","Grape",
    "Peach","Cactus","Bamboo","Dragon Fruit","Loquat","Green Apple",
    "Avocado","Radish","Broccoli","Cauliflower","Potato","Bell Pepper",
    "Pepper","Mushroom","Rose","Sunflower","Lilac","Foxglove","Daffodil",
    "Orange Tulip","Raspberry","Kiwi","Olive",
    -- Uncommon
    "Sugar Apple","Cocomango","Brussels Sprout","Elder Strawberry",
    "Beanstalk","Giant Pinecone","Feijoa","Blue Raspberry","Horned Melon",
    "Romanesco","Mandrake","Cacao","Prickly Pear","Baobab","Buttercup",
    "Protea","Orange Delight","Yarrow","Ackee","Peanut",
    -- Rare
    "Maple Resin","Kniphofia","Ember Lily","Burning Bud","Hollow Bamboo",
    "Auburn Pine","Autumn Shroom","Speargrass","Fall Berry","Firewell",
    "Torchflare",
    -- Legendary
    "Crimson Thorn","Asteris","Gem Fruit","Coilvine","Octobloom","Zebrazinkle",
    -- Mythical+
    "Candlite","Crunchnut","Hexberry","Yellow Core","Madcrown Vine",
    "Magma Pepper","Plumwillow","Blooming Cactus","Confetti Tula",
    "Shimmersprout","Crimson Cranberry","Purple Dahlia","Pink Lily",
...
local Settings = {
    ...
    SeedRain  = {Enabled = false, SelectedSeed = SEED_RAIN_LIST[1], Radius = 40, Amount = 10, Interval = 2},
